...
<div class="col-md-8 col-sm-12">
	...
	<section class="owl-carousel owl-spotlight">
		<div>
			<article class="spotlight-item">
				<div class="spotlight-img">
					<img alt="" src="<?=  PUBLIC_URL ?> /images/product/16.jpg" class="img-responsive" />
		...
		<div>
			<article class="spotlight-item">
				<div class="spotlight-img">
					<img alt="" src="<?=  PUBLIC_URL ?> /images/product/1.jpg" class="img-responsive" />
		...
		<div>
			<article class="spotlight-item">
				<div class="spotlight-img">
					<img alt="" src="<?=  PUBLIC_URL ?> /images/product/2.jpg" class="img-responsive" />
					<a href="#" class="cate-tag">Mobile</a>
				</div>
		...
		<div class="row">
			<div class="col-md-4 col-sm-4 col-xs-12">
				<div class="spotlight-item-thumb">
					<div class="spotlight-item-thumb-img">
						<a href="#">
							<img alt="" src="<?=  PUBLIC_URL ?> /images/product/3.jpg" />
						</a>
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
				<div class="spotlight-item-thumb">
					<div class="spotlight-item-thumb-img">
						<a href="#">
							<img alt="" src="<?=  PUBLIC_URL ?> /images/product/4.jpg" />
						</a>
						<a href="#" class="cate-tag">Computing</a>
					</div>
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
				<div class="spotlight-item-thumb">
					<div class="spotlight-item-thumb-img">
						<a href="#">
							<img alt="" src="<?=  PUBLIC_URL ?> /images/product/5.jpg" />
						</a>
